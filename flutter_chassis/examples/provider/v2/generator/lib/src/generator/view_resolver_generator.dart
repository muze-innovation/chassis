...
class DataResolverGenerator extends GeneratorForAnnotation<ViewResolver> {
  final _parentClassType = 'ViewResolver';
  ...
  generateForAnnotatedElement(
    ...
    if (element is ClassElement) {
      ...
      try {
        ...
        log.severe(
            '[ERROR] ${element.name} did not inherit ViewResolverEntry.');
      }
    }
  }
  ...
  Method _generateRouteTableMethod(
    ...
    return Method((builder) {
      final paramType = 'ViewResolver';
      final paramName = 'viewResolver';
